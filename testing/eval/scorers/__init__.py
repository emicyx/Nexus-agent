...
from testing.eval.scorers.contract import (
    db_assert,
    golden_phrase,
    job_zero_egress,
    pydantic_valid,
...
# 触发注册（import 副作用）
_ = (
    db_assert, golden_phrase, job_zero_egress, pydantic_valid,
    regex_not_match, sandbox_file, trajectory_rule, llm_rubric,
)
